       <div class="col-12 stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title text-center">Input Data Barang Masuk</h4><hr style="width: 5%">
                  
                      <form class="forms-sample" method="post" action="<?=site_url('Data/insert_barang_masuk')?>">

                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Stok Barang Masuk</label>
                          <div class="col-sm-7">
                            <input type="text" name="stok_masuk" class="form-control" placeholder="Stok Barang Masuk">
                          </div>
                        </div>


                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Tanggal Barang Masuk</label>
                          <div class="col-sm-7">
                            <input type="date" name="tgl_masuk" class="form-control" placeholder="Nama Barang">
                          </div>
                        </div>
      ...
      <div class="modal-content" style="background-color: #fff">
          ...
          <div class="modal-body">
            <div class="mailbox-messages table-responsive">
                 <div class="table-responsive" id="xbrg">
